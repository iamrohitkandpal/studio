...
const ExperienceItem: React.FC<ExperienceItemProps> = ({ company, role, duration, location, description }) => (
  <div className="mb-6 last:mb-0 glass-card p-6 rounded-lg shadow-lg border border-border/30">
    ...
    <p className="text-md font-semibold text-foreground/90">{role}</p>
    <p className="text-sm text-foreground/60 mb-3">{duration} ({location})</p>
...
const Experience: React.FC = () => {
  const experiences: ExperienceItemProps[] = [
    ...
    },
    {
      ...
      duration: 'Dec 2024 – Jan 2025', // Dates seem off, Dec 2024 - Jan 2025 happens before Jun 2024? Assuming Dec 2023 - Jan 2024
