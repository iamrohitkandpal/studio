    ...
    <div className="glass-section section-transition min-h-[calc(100vh-10rem)] flex flex-col md:flex-row items-center justify-center text-center md:text-left gap-8 md:gap-12 py-16 md:py-24">
      ...
      >
        ...
        <div className="flex justify-center md:justify-start gap-4">
          ...
          {[
            { icon: Github, href: "https://github.com/iamrohitkandpal", label: "GitHub Profile" },
            { icon: Linkedin, href: "https://linkedin.com/in/rohit-kandpal-", label: "LinkedIn Profile" },
            { icon: Mail, href: "mailto:iamrohitkandpal@gmail.com", label: "Email" },
